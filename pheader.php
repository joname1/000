...
<head>
    ...
    <title><?php echo $pagetitle.' - '. $title;?> - 让世界没有距离 想看什么就搜什么</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header" style="z-index:1000">
                ...
                <a class="navbar-brand" href="/"><i class="fa fa-youtube"></i> <?php echo $title; ?></a>
            </div>
...
<div class="alert alert-danger alert-dismissible" role="alert" style="text-align:center; margin-top:-18px;">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    如遇到某些视频无法播放,可能是版权问题或网络延迟,请<strong>刷新</strong>或<strong>播放其他视频.</strong>
</div>