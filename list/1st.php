...
<h3 style="text-align:center;"><i class="fa fa-youtube-play fa-3"></i> 推荐视频</h3>
<ul class="list-unstyled video-list-thumbs row">
<?php

$channelId = $home_v1;
$maxResults = 50;//首页视频显示数量，最多50
$API_key = $youtube_api;
...
foreach($video_list->items as $item)
{
	...
	echo '<li id="'. $item->id->videoId .'" class="col-lg-3 col-sm-6 col-xs-6 youtube-video">
		<a href="./video.php?v='. $item->id->videoId .'" target="_blank" title="'. $item->snippet->title .'">
			<img src="http://pics.y0utube.gq/thumbnail.php?vid='. $item->id->videoId .'" alt="'. $item->snippet->title .'" class="img-responsive" height="130px" />
